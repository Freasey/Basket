...
const delaydisp= ()=>{for (let n = 0; n < document.querySelectorAll('.maintitle').length; n++) {
            ...
            document.getElementsByClassName('daftar')[0].style.display="inline";
        };
//delay back basket
...
const materi =()=> {                   
                    ...
                    setTimeout( function() { window.location.href = 'Assets/Materi/materi.html' }, 1000 );
                    document.getElementsByClassName("maintitle")[0].src= 'Assets/button materi 2-12.png';
...
const soal =()=> {  document.getElementById('awal').style.display='inline';
                    setTimeout( function() { document.getElementById('awal').style.opacity='1'; }, 50 );
                    document.getElementsByClassName("maintitle")[1].src= 'Assets/button soal 2-14.png';
                    setTimeout( function() { window.location.href = 'Assets/Soal/Index.html' }, 1000 );
...
const turu = () => {
        ...
        document.getElementById("tombolmulai").src= 'Assets/button-03.png';
    ...
    const intro=document.getElementById('intro')
        const basktro= document.getElementById('introbask')
        const isi= document.getElementById('isi')
        setTimeout(() => {
        isi.style.width='100%' ;
        basktro.style.transform='translate(230px, 250px)';  
        setTimeout(() => {
